...
val cavernKeyItem = new Item("Relic of Fractured Light", "Cavern Key Item", 0)

val forestUnlockedItem = new Item("Chrono Prism", "Forest Unlock Item", 0)
...
val healingIII = new Item("Healing III", "Speacial", 0)
...
val forestKeyItem = new Item("Relic of the Eternal Cycle", "Forest Key Item", 0)
